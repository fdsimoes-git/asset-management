...
const translations = {
  en: {
    ...
    'chat.errorInvalidKey': 'Your API key appears to be invalid. Please check it in Settings.',
  ...
  pt: {
    ...
    'chat.errorInvalidKey': 'Sua chave API parece ser inválida. Verifique nas Configurações.',
