...
const translations = {
  en: {
    ...
    'admin.passwordReset': 'Password reset successfully for "{username}"',
    'admin.passwordMinLength': 'Password must be at least 8 characters',
    'admin.enterNewPassword': 'Enter new password for',
    ...
    'error.resetPassword': 'Error resetting password',
  ...
  pt: {
    ...
    'admin.passwordReset': 'Senha redefinida com sucesso para "{username}"',
    'admin.passwordMinLength': 'A senha deve ter pelo menos 8 caracteres',
    'admin.enterNewPassword': 'Insira a nova senha para',
    'admin.newPassword': 'Nova Senha',
    'admin.minChars': 'M\u00ednimo 8 caracteres',
    'admin.resetPasswordBtn': 'Redefinir Senha',
    ...
    'error.resetPassword': 'Erro ao redefinir senha',
